...
function PdfUploader({ setparentImagesUploadedImages, imagesError, setImagesError }) {
  ...
  return (
    <Container fluid style={{ marginTop: "30px" }}>
      <div className="roboto-medium-20px-body1" style={{ marginBottom: "25px" }}>Upload PDF</div>
